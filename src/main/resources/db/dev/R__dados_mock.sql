...
ALTER TABLE tipo_solicitacao MODIFY id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE);
ALTER TABLE solicitacao MODIFY id GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE);
